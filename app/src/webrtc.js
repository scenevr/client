...
var me = 'bnolan';
var roomKey = 'blah';
var roomLink = '/blah/blah';
var initiator = true;
var pcConfig = {
  iceServers : [{ url : "stun:stun.services.mozilla.com"}]
};
var pcConstraints = { audio : true, video : false };
var offerConstraints = { audio : true, video : false };
...
function onTurnResult() {
  var turnServer = {"username": "1424853126:bnolan", "password": "0T8RzLGMp2j5i23o1/9VV2hacgU=", "uris": ["turn:130.211.241.132:3478?transport=udp", "turn:130.211.241.132:3478?transport=tcp", "turn:130.211.241.132:3479?transport=udp", "turn:130.211.241.132:3479?transport=tcp"]};
